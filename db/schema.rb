...
ActiveRecord::Schema.define(version: 2021_04_18_033126) do
  ...
  create_table "shippingaddresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_shippingaddresses_on_order_id"
  end
  ...
  add_foreign_key "shippingaddresses", "orders"
end
